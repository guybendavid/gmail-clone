...
const eslintConfig: Linter.Config[] = [
    ...
    rules: {
      ...
      "no-restricted-syntax": [
        ...
        },
        {
          ...
          message:
            "Do not use 'let'. Use 'const' instead. If you need to reassign, consider refactoring to avoid mutation."
        },
        {
          selector:
            "JSXAttribute[name.name=/^on[A-Z]/] > JSXExpressionContainer > ArrowFunctionExpression > BlockStatement",
  ...
  {
    files: ["**/models/*.ts", "**/resolvers/*.ts", "custom-eslint-rules.ts", "find-unimported-exports.ts", "server/graphql/context-middleware.ts"],
    rules: {
      // To do: enable and refactor
    ...
    rules: {
      "no-restricted-syntax": [
        "error",
        {
          selector: "Program",
          message:
            "JavaScript files (.js/.jsx) are not allowed in this TypeScript project. Please use .ts/.tsx instead."
        }
      ]
    }
  },
