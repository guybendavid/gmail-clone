...
const [clientTypeScriptConfigs, clientReactConfigs, nodeServerConfigs] = await Promise.all([
  ...
  getRecommendedTypeScriptConfig({
    ...
    disallowJsIgnoredFileGlobs: [
      "server/db/config/**/*.js",
      "server/db/migrations/**/*.js",
      "server/db/seeders/**/*.js"
    ]
  })
]);

const clientConfigs = [...clientTypeScriptConfigs, ...clientReactConfigs];
